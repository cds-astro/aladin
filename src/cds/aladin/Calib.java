...
//  }
   ...
   static double EPSILON = 1./(60.*60.*100.*100.);   // Milli arcseconde
...
//                );
         ...
         for( int proj=1; proj<projType.length; proj++ ) {
            ...
            for( int j=0; j<testCenter.length; j++ ) {
               ...
               c.GetXY(coo);
               if( !equalEpsilon(coo.y,y) || !equalEpsilon(coo.x,x) ) {
                  if( !erreur ) System.out.print(" Error");
                  erreur=true;
               ...
               try {
                  ...
                  for( int i=0; i<1000; i++ ) {
                     ...
                     c.GetCoord(coo);
                     System.out.println("random avant GetXY"+coo.al+" "+coo.del);
                    c.GetXY(coo);
                    System.out.println("random apr̬s GetXY"+coo.x+" "+coo.y);
                    if(  !equalEpsilon(coo.y,y) ) {
                        if( !erreur ) System.out.print(" Error");
                       erreur=true;
                        System.out.print("\nrandom y"+centre+" no bijective: xy=("+x+","+y+") => coo=("+coo.al+","+coo.del+") => xy=("+coo.x+","+coo.y+")");
                       // break;
                     }
                    if( !equalEpsilon(coo.x,x)  ) {
                        if( !erreur ) System.out.print(" Error");
                       erreur=true;
                        System.out.print("\nrandom x"+centre+" no bijective: xy=("+x+","+y+") => coo=("+coo.al+","+coo.del+") => xy=("+coo.x+","+coo.y+")");
                        break;
                     }
                  }
               } catch( Exception e ) {
