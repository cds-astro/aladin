...
public final class Calib  implements Cloneable {
   ...
   static public Calib copy(Calib c) {
      Calib a = new Calib();
      a.aladin = c.aladin;
      a.xyapoly = new double[11]; System.arraycopy(c.xyapoly,0,a.xyapoly,0,10);
      a.xydpoly = new double[11]; System.arraycopy(c.xydpoly,0,a.xydpoly,0,10);
      a.adypoly = new double[11]; System.arraycopy(c.adypoly,0,a.adypoly,0,10);
      a.adxpoly = new double[11]; System.arraycopy(c.adxpoly,0,a.adxpoly,0,10);
      a.epoch = c.epoch;
          ...
          case SIP:     
               ...
               if ((xyapoly[1] != 0)&&(xyapoly[1] != 1)&&(aladin == 0))
               {
                  ...
                  while (iter < niter)
                  {
                     ...
                     iter++ ;
                     m1 = xyapoly[1]+
                     //      xyapoly[3]*xx/Math.sqrt(xx*xx+yy*yy) +
                           2*xyapoly[4]*xx +
                           xyapoly[5]*yy  +
                           3*xyapoly[7]*xx*xx +
                           xyapoly[9]*yy*yy +
