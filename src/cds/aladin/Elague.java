 ...
 */
public class Elague extends MyIcon {
  ...
  /** Creation */
   protected Elague(Aladin aladin) {
      super(aladin,32,24);
      ELAGUE= "prune"; //aladin.chaine.getString("PRUNE");
   }
   ...
   private boolean isAvailable() {
      return !aladin.hipsMarket.isFree();
   }
