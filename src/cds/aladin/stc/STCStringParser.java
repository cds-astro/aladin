...
public class STCStringParser {
    ...
    private String[] splitShapesStrings(String stcString, boolean reduced) {
        ...
        if (reduced) {
           // Prise en compte de la notation scientifique - PF Feb 2020
           regexp = shapes + "(\\s+[A-Za-z0-9]+)?(\\s+[-]?[0-9Ee\\+\\-\\.]+)+";
...
//        return !m.find();
       ...
       // PF - Fev 2020 - Plus rapide et permet de supporter la notation scientifique
       for( char c : input.toCharArray() ) if( Character.isLetter(c) && c!='e' && c!='E' ) return false;
       return true;
...
//        stc =  parser.parse("Polygon 9.4996719542 0.08626E+2 9.4996724321 8.6457321609 9.4780377021 8.6457320742 9.4780383392 8.6262876304");
//    }
}
