...
/** Class for dealing with sets of integer ranges.
    ...
    This code was inspired by Jan Kotek's "LongRange" class, but has been
...
public class Range
  ...
  private static boolean generalAllOrNothing1 (Range a, Range b,
  ...
  private static boolean generalAllOrNothing2 (Range a, Range b,
    boolean flip_a, boolean flip_b)
    {
    int iva = flip_a ? 0 : -1;
    while (iva<a.sz)
  ...
  private static boolean generalAllOrNothing (Range a, Range b,
    boolean flip_a, boolean flip_b)
    {
    if (a.isEmpty())
  ...
  private static Range generalUnion1 (Range a, Range b,
    boolean flip_a, boolean flip_b)
    {
    Range res = new Range();
  ...
  /** Internal helper function for constructing unions, intersections
      and differences of two Ranges. */
  private static Range generalUnion2 (Range a, Range b,
    boolean flip_a, boolean flip_b)
    {
    Range res = new Range();
    int iva = flip_a ? 0 : -1;
  ...
  private static Range generalUnion (Range a, Range b,
    boolean flip_a, boolean flip_b)
    {
    if (a.isEmpty())
  ...
  @Deprecated
  public boolean containsAny (Range other)
  ...
  /** After this operation, the Range contains the intersection of itself and
      [a;b[. */
  ...
  /** After this operation, the Range contains the union of itself and
      [a;b[. */
  ...
  /** After this operation, the Range contains the difference of itself and
      [a;b[. */
