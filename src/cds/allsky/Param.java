...
//   mocOrder         ("[s[/t]] [<nnMB[:tts]]","Specifical MOC order (MOC & STMOC action, s-spaceOrder, t-timeOrder, maxLimit, degradation rule",A.SPE),
 ...
 ;
   ...
   class A {
      ...
      static final int RGB  = 4;        // Dédié à l'action RGB
      static final int SPE  = 8;        // Dédié à une action spécifique
      static final int XXX  = 16;       // 
      static final int HIPS = 32;       // Paramètre du HiPS
      static final int IMG  = 64;       // Gestion des images en input
      static final int CTRL = 128;      // Controle du processus de génération
